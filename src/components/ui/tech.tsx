...
const techIcons: FloatingIconsHeroProps["icons"] = [
  ...
  { id: 5, icon: IconReact, className: "top-[5%] left-[30%]" },
  { id: 6, icon: IconExpress, className: "top-[5%] right-[30%]" },
  { id: 7, icon: IconNode, className: "bottom-[8%] left-[25%]" },
  { id: 8, icon: IconFigma, className: "top-[40%] left-[15%]" },
  { id: 9, icon: IconVite, className: "top-[75%] right-[25%]" },
  { id: 10, icon: IconTailwind, className: "top-[90%] left-[70%]" },
  { id: 11, icon: IconAstro, className: "top-[50%] right-[5%]" },
  { id: 12, icon: IconMongo, className: "top-[55%] left-[5%]" },
  { id: 13, icon: IconMysql, className: "top-[5%] left-[55%]" },
  { id: 14, icon: IconAws, className: "bottom-[5%] right-[45%]" },
  { id: 15, icon: IconDocker, className: "top-[25%] right-[20%]" },
  { id: 16, icon: IconPython, className: "top-[60%] left-[30%]" },
  { id: 17, icon: IconGit, className: "top-[65%] right-[8%]" },
]
