...
const ScannerCardStream = ({
  ...
  return (
    <main ref={sectionRef} className="relative flex h-[min(100vh,560px)] w-full items-center justify-center overflow-hidden bg-background supports-[height:100dvh]:h-[min(100dvh,560px)]">
