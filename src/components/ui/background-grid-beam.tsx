// GridBeam.tsx
// Animated gradient beam over a subtle grid background. Wrap page sections
// (e.g. the About hero) and layer content on top of the beam.
...
export const GridBeam: FC<GridBeamProps> = ({ children, className }) => (
